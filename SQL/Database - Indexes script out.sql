...
Date: 22/09/2017
Description: Script out indexes
                    ...
                    ELSE
                        N'CREATE ' + CASE
                                     ...
                                     END + CASE
                                               WHEN si.index_id > 1 THEN N'NON'
                                               ELSE N''
                                           END + N'CLUSTERED ' + N'INDEX ' + QUOTENAME( si.name ) + N' ON ' + QUOTENAME( sc.name ) + N'.' + QUOTENAME( t.name )
                        + N' '
                END +
      ...
      CASE
          WHEN row_compression_partition_list IS NOT NULL
              ...
              + CASE
                ...
                END + CASE
                          WHEN row_compression_partition_list IS NOT NULL
                               AND page_compression_partition_list IS NOT NULL THEN N', '
                          ELSE N''
                      END
              + CASE
