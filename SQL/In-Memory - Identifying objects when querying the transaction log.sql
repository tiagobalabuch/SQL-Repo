...
Author: Frank Gill
Date: 22/09/2017
Description: Identifying in-memory objects when querying the transaction log.
...
INNER JOIN sys.memory_optimized_tables_internal_attributes m ON ( f.xtp_object_id - 2147483648 ) = ( m.xtp_object_id + 2147483648 )
