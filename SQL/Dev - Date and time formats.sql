...
Date: 22/09/2017
Description: List of data and time formats
Original link: https://www.mssqltips.com/sqlservertip/4052/build-a-cheat-sheet-for-sql-server-date-and-time-formats/
...
SELECT  @sql = @sql + N' UNION ALL SELECT [style #] = ' + style + ', expression = N''CONVERT(CHAR(''
