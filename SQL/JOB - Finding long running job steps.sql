...
Date: 22/09/2017
Description: How to Find Long Running Job Steps
...
JOIN JobHistStats jhs ON jd.job_id = jhs.job_id
                         AND jd.step_id = jhs.step_id
JOIN msdb..sysjobs j ON jd.job_id = j.job_id
JOIN msdb..sysjobsteps sjs ON jd.job_id = sjs.job_id
                              AND   jd.step_id = sjs.step_id
